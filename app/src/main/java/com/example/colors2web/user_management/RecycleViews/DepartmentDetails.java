...
//EmployeePut Class Back Up is Here
...
//
//    @BindView(R.id.tv_edepartment_id)
//    EditText edepartment_id;
//
...
//                            edepartment_id.setText(String.valueOf(empList.get(i).getDepartmentId()));
//
...
//                Integer did = edepartment_id.getText().length();
//
...
//                    spin.add(dep1.getId());
//                }
//                spinner.setAdapter(new ArrayAdapter<Integer>(EmployeePut.this, android.R.layout.simple_spinner_dropdown_item, spin));
...
//                call.cancel();
//                Log.e("SPinner-loading", call.toString());
//
//            }
//
//        });
